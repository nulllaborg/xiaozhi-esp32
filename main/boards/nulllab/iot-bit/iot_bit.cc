...
#define TAG "NulllabIotBit"

class NulllabIotBit : public WifiBoard {
private:
    Button boot_button_;
    ...
    void InitializeDisplayI2c() {
        i2c_master_bus_config_t bus_config = {
            ...
            .sda_io_num = static_cast<gpio_num_t>(DISPLAY_SDA_PIN),
...
public:
    NulllabIotBit() : boot_button_(BOOT_BUTTON_GPIO) {
